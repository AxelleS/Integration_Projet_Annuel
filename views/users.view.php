<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12 placing-content max-scrollable">
    <div class="row offset-lg-1 offset-md-1 offset-sm-1 offset-xs-1 col-lg-11 col-md-11 col-sm-11 col-xs-11 organization_title">
        ...
        <h1 class="offset-lg-1 offset-md-1 offset-sm-1 offset-xs-1">Utilisateurs</h1>
    </div>
    <div class="row site-center">
        <a class="col-lg-3 offset-lg-1 col-md-3 offset-md-1 col-sm-10 offset-sm-2 col-xs-10 offset-xs-2 placed" href="<?php echo DIRNAME.Route::getSlug('users','index').'/customer'; ?>">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <p class="titre-organization"><b>Clients</b></p>
        </div>
        </a>
        <a class="col-lg-3 offset-lg-1 col-md-3 offset-md-1 col-sm-10 offset-sm-2 col-xs-10 offset-xs-2 placed" href="<?php echo DIRNAME.Route::getSlug('users','index').'/admin'; ?>">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
