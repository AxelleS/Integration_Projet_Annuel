...
<input class="<?php echo $config['style']['classInput']?>"  type="radio" name="<?php echo $config['is_pregnant']['name']?>" value="<?php echo $config['is_pregnant']['button_choice']['yes']['value']?>"><?php echo $config['is_pregnant']['button_choice']['yes']['name']?>
<input class="<?php echo $config['style']['classInput']?>"  type="radio" name="<?php echo $config['is_pregnant']['name']?>" value="<?php echo $config['is_pregnant']['button_choice']['no']['value']?>"><?php echo $config['is_pregnant']['button_choice']['no']['name']?>

<p class="<?php echo $config['style']['classText']?>"><?php echo $config['is_wheelchair']['nameView']?></p>
<input class="<?php echo $config['style']['classInput']?>"  type="radio" name="<?php echo $config['is_wheelchair']['name']?>" value="<?php echo $config['is_wheelchair']['button_choice']['yes']['value']?>"><?php echo $config['is_pregnant']['button_choice']['yes']['name']?>
<input class="<?php echo $config['style']['classInput']?>"  type="radio" name="<?php echo $config['is_wheelchair']['name']?>" value="<?php echo $config['is_wheelchair']['button_choice']['no']['value']?>"><?php echo $config['is_pregnant']['button_choice']['no']['name']?>

<p class="<?php echo $config['style']['classText']?>"><?php echo $config['is_deaf']['nameView']?></p>
<input class="<?php echo $config['style']['classInput']?>"  type="radio" name="<?php echo $config['is_deaf']['name']?>" value="<?php echo $config['is_deaf']['button_choice']['yes']['value']?>"><?php echo $config['is_pregnant']['button_choice']['yes']['name']?>
<input class="<?php echo $config['style']['classInput']?>"  type="radio" name="<?php echo $config['is_deaf']['name']?>" value="<?php echo $config['is_deaf']['button_choice']['no']['value']?>"><?php echo $config['is_pregnant']['button_choice']['no']['name']?>
