<?php include('header.php'); ?>
    ...
    <main>
        ...
        <section class="video row">
            <div class="col_4"></div>
            <iframe class="col_8" src="https://www.youtube.com/embed/bzzKksk_z2k?rel=0" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
            <div class="col_4"></div>
        </section>

        <section class="escape-room row">
                <div class="col_1"></div>
                <section class="col_4 room">
                    <!-- Affiche par défaut -->
        ...
        <section class="map row">
            <div class="col_4"></div>
            <!-- Map google map -->
            <article class="col_5"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2625.475184322657!2d2.3874704158722255!3d48.84914850931109!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e6727347e25d67%3A0xc73e22c1131584f7!2s242+Rue+du+Faubourg+Saint-Antoine%2C+75012+Paris!5e0!3m2!1sfr!2sfr!4v1516803151575" frameborder="0" style="border:0" allowfullscreen></iframe></article>
            <!-- Adresse entreprise -->
            <article class="col_3">
